...
Assumes all images are in the form of a zip file with name (without .zip extension) specified by "Dataset".  
If loading from Google Drive, assumes zip file is in `'My Drive/COVID-19-Affected Lung CT Generative Network/'`. 
If loading locally, assumes zip file is in the same directory as this file.
"""
